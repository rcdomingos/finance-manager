...
INSERT INTO "new_Transaction" ("amount", "bankAccountId", "createdAt", "creditCardId", "date", "description", "id", "paymentMethod", "subCategoryId", "type", "updatedAt", "userId") SELECT "amount", "bankAccountId", "createdAt", "creditCardId", "date", "description", "id", "paymentMethod", "subCategoryId", "type", "updatedAt", "userId" FROM "Transaction";
